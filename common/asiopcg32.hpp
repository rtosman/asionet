/*
    implementation of Melissa O'Neill's PCG32 by elbeno
    https://github.com/elbeno/constexpr/blob/master/src/include/cx_pcg32.h
*/
#ifndef _ASIOPCG32_HPP_INCLUDED
#define _ASIOPCG32_HPP_INCLUDED
#include "asionet.hpp"
